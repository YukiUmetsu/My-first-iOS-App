...
#import "SecondExplanationView.h"

@implementation SecondExplanationView
{
...
-(void)setPicAndBtn
{
    ...
    [btnToExplanation setTitle:@"3.「同じ余りをつくれ！」の説明に行く" forState:UIControlStateNormal];
...
{
    [self performSegueWithIdentifier:@"ToLastExplanation" sender:self];
}
@end